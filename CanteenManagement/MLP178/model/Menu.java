 ...
 */
  ...
  @Override
    ...
    Menu menu = (Menu) obj;
    if (Objects.equals(menuId, menu.menuId) && Objects.equals(menuCat, menu.menuCat)
        && Objects.equals(menuItem, menu.menuItem) && Objects.equals(menuCost, menu.menuCost)
        && Objects.equals(menuQuantity, menu.menuQuantity) && Objects.equals(menuCalories, menu.menuCalories)
