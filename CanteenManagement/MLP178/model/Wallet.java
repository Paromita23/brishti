 ...
 */
  ...
  @Override
    ...
    if (Objects.equals(walletId, wallet.walletId) && Objects.equals(customerId, wallet.customerId)
        && Objects.equals(walletType, wallet.walletType) && Objects.equals(walletAmount, wallet.walletAmount)) {
      return true;
    } 
    return false;
  }
