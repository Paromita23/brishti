 ...
 */
  ...
  @Override
    ...
    if (Objects.equals(vendorId, vendor.vendorId) && Objects.equals(vendorName, vendor.vendorName)
        && Objects.equals(vendorUsername, vendor.vendorUsername) && Objects.equals(vendorNumber, vendor.vendorNumber)
        && Objects.equals(vendorEmail, vendor.vendorEmail) && Objects.equals(vendorPassword, vendor.vendorPassword)) {
      return true;
    }
    return false;
  }
