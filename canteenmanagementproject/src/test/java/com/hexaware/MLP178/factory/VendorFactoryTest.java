...
/**
  ...
  public final void testListAllSome(@Mocked final VendorDAO dao) {
    final Vendor v2 = new Vendor(101, "XYZ", "xyz101", "9999977654", "XYZ@GMAIL.COM", "xyz123");
    final Vendor v3 = new Vendor(102, "RKP", "rkp102", "9988877654", "RKP@GMAIL.COM", "rkp12");
    ...
    assertEquals("xyz101", ven1[0].getVendorUsername());
    assertEquals("rkp102", ven1[1].getVendorUsername());
    ...
    assertEquals("xyz123", ven1[0].getVendorPassword());
    assertEquals("rkp12", ven1[1].getVendorPassword());
  }
   /**
   * Tests that a list with some employees is handled correctly.
   * @param dao mocking the dao class
   */
  @Test
  public final void testFindByVendorName(@Mocked final VendorDAO dao) {
    final Vendor v2 = new Vendor(101, "XYZ", "xyz101", "9999977654", "XYZ@GMAIL.COM", "xyz123");
    final Vendor v3 = new Vendor(102, "RKP", "rkp102", "9988877654", "RKP@GMAIL.COM", "rkp12");
    new Expectations() {
      {
  ...
  /**
   * Tests that a list Employ Search by Vendor name.
   * @param dao mocking the dao class.
   */
  @Test
  public final void testListByVendorName(@Mocked final VendorDAO dao) {
    final Vendor v2 = new Vendor(101, "XYZ", "xyz101", "9999977654", "XYZ@GMAIL.COM", "xyz123");
    final Vendor v3 = new Vendor(102, "RKP", "rkp102", "9988877654", "RKP@GMAIL.COM", "rkp12");
    new Expectations() {
      {
  ...
  public final void testValidateVendor(@Mocked final VendorDAO dao) {
    new Expectations() {
      {
        dao.authenticate("XYZ", "xyz123"); result = 1;
        dao.authenticate("RKP", "rkp12"); result = 1;
        dao.authenticate("TEZ", "tez123"); result = 0;
      }
    };
    new MockUp<VendorFactory>() {
      @Mock
    ...
    assertEquals(1, VendorFactory.validateVendor("XYZ", "xyz123"));
    assertEquals(1, VendorFactory.validateVendor("RKP", "rkp12"));
    assertEquals(0, VendorFactory.validateVendor("TEZ", "tez123"));
  }
}
